...
const Ad = () => {
  ...
  return (
    ...
    //   {!loading && (
    //     <Card
    //       className="ad  position-relative"
    //       style={{ minHeight: "130px", border: "1px solid red" }}
    //     >
    ...
    //                 <Card.Title>
    //                   <h2 className="fs-24">{banner.title}</h2>
    //                 </Card.Title>
    //               </div>
    //               <div className="col-md-12">
    ...
    //             <img src={banner.image} alt="" style={{ height: "100px" }} />
    //           </div>
    //           <div className="content-wrapper d-flex flex-column gap-1">
    //             <div className="content-title">{banner.title}</div>
    //             <div className="contetn-discription">{banner.description}</div>
    //           </div>
    //         </div>
    //       </Card.Body>
